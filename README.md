## Syllabus: HUDM 5001 Section 001 – Programming for Data Science  

HUDM 5001 Section 001 CRN 38956, Fall 2026  
Syllabus version: 08.31.2026  
...
**Instructor**  
[Chenguang Pan](https://cpan.ai/)  
cp3280@tc.columbia.edu 


When emailing me, please remember to include `[HUDM5001]` in your email subject line.
...
-	[Colab](https://colab.research.google.com/) (or other IDE tools like PyCharm, VSCode, etc.)
-	[GitHub](https://github.com/)
-	[SQLite](https://www.sqlite.org/download.html)

### Topics Covered
- Python Programming
    - Intro to Colab, Conda, JupyterNotebook
...
|:---:	|:---:	|---	|---	| --- |
| Week 1 | 9/8 | Syllabus and Intro to Python | Pre-class Survey  | 
| Week 2 | 9/15 | Python Intro: Data Types, Variables and Expressions | A |McKinney Chs 1&2; [OM01](https://www.geeksforgeeks.org/python/python-variables/)
| Week 3 | 9/22 |  Python Introduction: Operators, Input/Output, Numpy	| A | McKinney Ch 4; [OM02](https://www.w3schools.com/python/python_operators.asp); [OM03](https://www.learndatasci.com/solutions/python-context-managers/)
| Week 4 | 9/29 |  Python Intro: Pandas 	| A | McKinney Ch 5; [OM04](https://www.w3schools.com/python/pandas/default.asp); [OM05](https://pandas.pydata.org/pandas-docs/stable/user_guide/10min.html)
| Week 5 | 10/6 |  Pandas, SQLite Database	| A | [OM05](https://pandas.pydata.org/pandas-docs/stable/user_guide/10min.html); [OM06](https://www.sqlite.org/about.html)
| Week 6 | 10/13 |  Control Structures and Iterables | A | [OM07](https://www.w3schools.com/python/python_conditions.asp); [OM08](https://www.geeksforgeeks.org/python/iterators-in-python/)
| Week 7 | 10/20 |  Functions, Lambdas, List Comprehensions	| A | McKinney Ch 3.2;[OM09](https://www.w3schools.com/python/python_functions.asp); [OM10](https://www.geeksforgeeks.org/python/global-local-variables-python/); [OM11](https://realpython.com/python-lambda/); [OM12](https://www.pythonforbeginners.com/basics/list-comprehensions-in-python)
| Week 8 | 10/27 | Midterm | 
| Week 9 | 11/3 |  Intro to Shell and GitHub. No in-person class due to College Holiday. Recording will be provided. |A | [OM13](https://medium.com/@abhishekj/an-intro-to-git-and-github-1a0e2c7e3a2f); [OM14](https://product.hubspot.com/blog/git-and-github-tutorial-for-beginners); [OM15](https://github.com/git-guides/git-add)
| Week 10 | 11/10 |  Python Classes, Object-Oriented Programming	| A | [OM16](https://docs.python.org/3/tutorial/classes.html); [OM17](https://www.w3schools.com/python/python_classes.asp)
| Week 11 | 11/17 |  Unit Testing and Exception Handling | A |
| Week 12 | 11/24 | Advanced Topics (1): Coding Practices with AI | |
| Week 13 | 12/1	| Advanced Topics (2): TBD   | |
| Week 14 | 12/8	| Jupyter Notebook Presentation | |
| Week 15 | 12/15	|  Final Project Discussion |  | |  
| Week 16 | 12/22	|  Final Project  | Final Report | |  

*OM means online materials. Coding Practices with AI will focus on vibe coding. Advanced Topics may cover one or two topics from Machine Learning, Deep Learning, Natural Language Processing, etc. It depends on teaching pace. 

### Programming Assignments, the Midterm, and the Final Project

*Programming Assignments*: 

The programming assignments consist of focused exercises related to each week’s lectures. You are expected to first try to complete the homework by yourself. If you work with others, please make sure that you understand all of the work, and that your final submission is your own work. The assignments will be posted on GitHub/Canvas no later than Tuesday and will be due the following Monday at 11:59pm, EST. The total possible points for each assignment may vary, and specific grading criteria will be provided with each assignment. I or our CA (if one is assigned) will view students’ submissions and make comments on them. Assignments turned in late will be subject to the following penalty: 10% of the total score will be deducted for each day past the due date. An assignment with the lowest score will be dropped when computing the final letter grade at the end of the semester.  

AI tools may be used on programming assignments under conditions described in the **AI Policy** section below. We will cover formatting details and any exceptions in our first class.

*Midterm*: 

The midterm will cover Weeks 1–7, and will be an in-person, paper-based exam. You will be allowed one 8 ½ x 11 (the standard US letter used in printers) one-sided **cheat sheet.** You’re allowed to bring a calculator.  

AI tools are not allowed for the midterm.  


*Final Project*: 

You will work with other students in the same group. Pick a dataset that you and your group find interesting. Example sources are found below. Feel free to select your data from any other source as appropriate.  

The final project should form a research question, and perform data pre-processing, data cleaning, outlier removal, and so on to sanitize your data as necessary. Explore your data to reveal interesting/useful information based on your project scenario, and create at least 2 visualizations that you find interesting/useful. Also, do at least one of the following, depending on your interests and background: (i) compute meaningful statistical quantities (e.g., means, correlations), (ii) perform a statistical test on the data (e.g., t-test), or (iii) fit a model to the data (e.g., regression).  
...
AI tools are not allowed for the final project.

*Attendance*: 

Regular attendance is required for this course. Missing more than two sessions will have a negative impact on your final grade.
...
|Component 	| Weight	|
|---	|:---:|
|Programming Assignments (drop one) |40%|  
|Midterm	|20%|
|Presentation	|10%|
|Final Project |30%|
...
Note that A+, B+, and C+ will be determined by the class curve, attendance, and overall performance in the course.

## AI Policy
Intellectual honesty is vital for an academic community and for the fair evaluation of your work by teaching staff. All work submitted in this course must be your own or that of your group, completed in accordance with the University’s academic policies, and you may not engage in unauthorized collaboration.  

Because working effectively with AI coding tools is part of what this course teaches, AI use is permitted on the weekly programming assignments under the conditions below. No AI tools are permitted on the midterm exam or the final project. 
1. **Attempt it yourself first.** For each programming assignment, work through the question on your own before opening any AI tool, and save that unassisted attempt as your original draft.  
2. **Then refine, if you want to.** You may use AI to debug, explain error messages, or improve your code. If you do, submit both the original draft and the revised draft, clearly labeled. An original draft that is incomplete or partly wrong is fine.  
3. **Say what you used.** Include a brief note (a comment block at the top of your submission is enough) naming the tool and what you used it for.  
4. **Own what you submit.** You are responsible for every line you turn in and should be able to explain how it works if asked.  

Submitting an AI-generated solution in place of a genuine original draft will be treated as an academic-integrity issue under the Academic Integrity policy below.
